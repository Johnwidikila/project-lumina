  ...
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        golden: "border-transparent bg-gradient-to-r from-golden to-golden-dark text-primary font-bold",
        success: "border-transparent bg-success text-primary-foreground",
        warning: "border-transparent bg-warning text-primary",
        level: "border-2 border-academic bg-academic/10 text-academic font-bold",
